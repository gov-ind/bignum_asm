...
; The prime 
...
;--------------------------------------------------------
BigNum_Shr      proc    uses ecx esi, address: dword, num_bytes: dword
                mov     esi, address
                mov     ecx, num_bytes
...
;            num_bytes : length of the byte array 
;--------------------------------------------------------
BigNum_Shl      proc    uses ecx esi, address: DWORD, num_bytes: DWORD
                mov     esi, address
                mov     ecx, num_bytes
...
;---------------------------------------------------------------------------------------------------------------
BigNum_Add      proc    uses eax ebx ecx esi edi, arg1: ptr byte, arg2: ptr byte, dest: ptr byte, num_bytes: dword, skip_first_byte: byte
                mov     esi, arg1
                mov     edi, arg2
                mov     ebx, dest
                mov     ecx, num_bytes
...
.code
MyFun proc arg1: dword, arg2: dword
    mov eax, arg1
    mov edx, arg2
    ret
MyFun endp
